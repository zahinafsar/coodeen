...
- UI ships key dialogs for Anthropic, OpenAI, and Google (plus a Custom option for OpenAI-compatible endpoints); any other provider requires hand-editing opencode's auth store.
