...
2. Open Settings in Coodeen (gear icon in the top bar)
...
API keys are stored locally in the SQLite database in your app data directory. They are never transmitted anywhere except directly to the provider's API endpoint during chat requests.
